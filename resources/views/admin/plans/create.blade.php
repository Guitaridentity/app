    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('certification') ? 'is-invalid' : '' }}" type="number" name="certification" id="certification" value="{{ old('certification', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('picture') ? 'is-invalid' : '' }}" type="number" name="picture" id="picture" value="{{ old('picture', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('events') ? 'is-invalid' : '' }}" type="number" name="events" id="events" value="{{ old('events', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courses') ? 'is-invalid' : '' }}" type="text" name="courses" id="courses" value="{{ old('courses', '') }}">
