    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-details.update", [$userDetail->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" name="text" id="text">{{ old('text', $userDetail->text) }}</textarea>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('www') ? 'is-invalid' : '' }}" type="text" name="www" id="www" value="{{ old('www', $userDetail->www) }}">
                @if($errors->has('www'))
                    <div class="invalid-feedback">
                        {{ $errors->first('www') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $userDetail->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $userDetail->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $userDetail->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $userDetail->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tiktok') ? 'is-invalid' : '' }}" type="text" name="tiktok" id="tiktok" value="{{ old('tiktok', $userDetail->tiktok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('soundcloud') ? 'is-invalid' : '' }}" type="text" name="soundcloud" id="soundcloud" value="{{ old('soundcloud', $userDetail->soundcloud) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('drooble') ? 'is-invalid' : '' }}" type="text" name="drooble" id="drooble" value="{{ old('drooble', $userDetail->drooble) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $userDetail->linkedin) }}">
