...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.guitar.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.guitars.update", [$guitar->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guitar_type') ? 'is-invalid' : '' }}" name="guitar_type_id" id="guitar_type_id">
                    @foreach($guitar_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guitar_type_id') ? old('guitar_type_id') : $guitar->guitar_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guitar_brand') ? 'is-invalid' : '' }}" name="guitar_brand_id" id="guitar_brand_id">
                    @foreach($guitar_brands as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guitar_brand_id') ? old('guitar_brand_id') : $guitar->guitar_brand->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guitar_brand_model') ? 'is-invalid' : '' }}" name="guitar_brand_model_id" id="guitar_brand_model_id">
                    @foreach($guitar_brand_models as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guitar_brand_model_id') ? old('guitar_brand_model_id') : $guitar->guitar_brand_model->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('serial') ? 'is-invalid' : '' }}" type="text" name="serial" id="serial" value="{{ old('serial', $guitar->serial) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guitar_color') ? 'is-invalid' : '' }}" name="guitar_color_id" id="guitar_color_id">
                    @foreach($guitar_colors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guitar_color_id') ? old('guitar_color_id') : $guitar->guitar_color->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strings_number') ? 'is-invalid' : '' }}" type="number" name="strings_number" id="strings_number" value="{{ old('strings_number', $guitar->strings_number) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('certified') ? 'is-invalid' : '' }}" type="number" name="certified" id="certified" value="{{ old('certified', $guitar->certified) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cert_code') ? 'is-invalid' : '' }}" type="text" name="cert_code" id="cert_code" value="{{ old('cert_code', $guitar->cert_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('to_sell') ? 'is-invalid' : '' }}" type="number" name="to_sell" id="to_sell" value="{{ old('to_sell', $guitar->to_sell) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('to_sell_price') ? 'is-invalid' : '' }}" type="number" name="to_sell_price" id="to_sell_price" value="{{ old('to_sell_price', $guitar->to_sell_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guitar_owner') ? 'is-invalid' : '' }}" name="guitar_owner_id" id="guitar_owner_id">
                    @foreach($guitar_owners as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guitar_owner_id') ? old('guitar_owner_id') : $guitar->guitar_owner->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_url') ? 'is-invalid' : '' }}" type="text" name="image_url" id="image_url" value="{{ old('image_url', $guitar->image_url) }}">
