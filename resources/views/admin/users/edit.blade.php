    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_prefix') ? 'is-invalid' : '' }}" type="text" name="mobile_prefix" id="mobile_prefix" value="{{ old('mobile_prefix', $user->mobile_prefix) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" type="text" name="language" id="language" value="{{ old('language', $user->language) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_birth') ? 'is-invalid' : '' }}" type="text" name="date_birth" id="date_birth" value="{{ old('date_birth', $user->date_birth) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_profession') ? 'is-invalid' : '' }}" name="user_profession_id" id="user_profession_id">
                    @foreach($user_professions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_profession_id') ? old('user_profession_id') : $user->user_profession->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disabled') ? 'is-invalid' : '' }}" type="number" name="disabled" id="disabled" value="{{ old('disabled', $user->disabled) }}" step="1">
