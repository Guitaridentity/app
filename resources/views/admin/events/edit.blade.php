    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('author') ? 'is-invalid' : '' }}" name="author_id" id="author_id">
                    @foreach($authors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('author_id') ? old('author_id') : $event->author->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $event->start) }}">
                @if($errors->has('start'))
                    <div class="invalid-feedback">
                        {{ $errors->first('start') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hours_endurance') ? 'is-invalid' : '' }}" type="number" name="hours_endurance" id="hours_endurance" value="{{ old('hours_endurance', $event->hours_endurance) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_vod') ? 'is-invalid' : '' }}" type="number" name="price_vod" id="price_vod" value="{{ old('price_vod', $event->price_vod) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_live') ? 'is-invalid' : '' }}" type="number" name="price_live" id="price_live" value="{{ old('price_live', $event->price_live) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_live') ? 'is-invalid' : '' }}" type="text" name="link_live" id="link_live" value="{{ old('link_live', $event->link_live) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_vod') ? 'is-invalid' : '' }}" type="text" name="link_vod" id="link_vod" value="{{ old('link_vod', $event->link_vod) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percent_to_author') ? 'is-invalid' : '' }}" type="number" name="percent_to_author" id="percent_to_author" value="{{ old('percent_to_author', $event->percent_to_author) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cover_img') ? 'is-invalid' : '' }}" type="text" name="cover_img" id="cover_img" value="{{ old('cover_img', $event->cover_img) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cover_video') ? 'is-invalid' : '' }}" type="text" name="cover_video" id="cover_video" value="{{ old('cover_video', $event->cover_video) }}">
